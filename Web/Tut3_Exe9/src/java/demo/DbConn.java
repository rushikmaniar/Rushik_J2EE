...
public class DbConn extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Connection con;
            if (connectivity.equals("Oracle")) {
                
                Class.forName("oracle.jdbc.driver.OracleDriver");
                con = DriverManager.getConnection("jdbc:oracle:thin:@//192.168.1.120:1521/orcl.ccrjt.com", "bca509", "111111");
            
            } else if (connectivity.equals("Access")) {  
